              ...
              <CardBody className="bg-danger ">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    ...
                    <h3 className="mb-0">
                      Rs <CountUp className="counter" end={45631} />
                      <small> This Month</small>
                    </h3>
                  </Media>
                </Media>
                  ...
                  <Table borderless>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="digits">Rs 6523</td>
                      </tr>
                      <tr>
                        <td>5</td>
                        <td className="digits">Rs 50.00</td>
                      ...
                      <div className="order-graph-bottom">
                        <Media>
                          ...
                          <Media body>
                            <h6 className="mb-0">
                              Saint Lucia{" "}
                              <span className="pull-right">Rs 157</span>
                            </h6>
                          </Media>
                        </Media>
                        <Media>
                          ...
                          <Media body>
                            <h6 className="mb-0">
                              Kenya <span className="pull-right">Rs 347</span>
                            </h6>
                          </Media>
                        </Media>
                        <Media>
                          ...
                          <Media body>
                            <h6 className="mb-0">
                              Liberia<span className="pull-right">Rs 468</span>
                            </h6>
                          </Media>
                        </Media>
                        <Media>
                          ...
                          <Media body>
                            <h6 className="mb-0">
                              Christmas Island
                              <span className="pull-right">Rs 742</span>
                            </h6>
                          </Media>
                        </Media>
                        <Media>
                          ...
                          <Media body>
                            <h6 className="mb-0">
                              Saint Helena{" "}
                              <span className="pull-right">Rs 647</span>
                            </h6>
                          </Media>
                        </Media>
                      </div>
